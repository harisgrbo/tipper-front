    ...
    <div class="database-wrapper relative">
                            ...
                            <div class="overflow-hidden bg-white">
                                <div class="w-full flex items-center justify-between px-4">
                                    ...
                                    <div class="flex flex-row items-center">
                                        <GlobalButton placeholder="Add user to pool" width="200px" bg-color="#fff"
                                                      @handle-button-action="showAddUserToPoolModal(pool)"></GlobalButton>
                                        <GlobalButton placeholder="TIP POOL" width="200px" bg-color="#ddd"
                                                      @handle-button-action="tipPool(pool)"></GlobalButton>
                                    </div>
                                </div>
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr v-for="(user, index) in pool_users" :key="index">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 username cursor-pointer"
                                            @click="removeUserFromPool(user, $route.params.id)">
        ...
        <div v-if="showPoolModal" class="add-user-modal">
            <div class="main-modal">
                ...
                <ul class="pt-4">
                    <li class="cursor-pointer w-full hover:bg-gray-100 hover:px-2 mb-3" v-for="(user, i) in users"
                        :key="i" @click="addUserToPool(user)">
                        {{ user.username }}
                    </li>
                </ul>
            </div>
