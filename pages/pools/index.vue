                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr v-for="(pool, index) in pools" :key="index">
                                        ...
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-left flex justify-center sm:pl-6">
                                            <svg v-show="pool.employments_count <= 0" @click="deletePool(pool.id)" xmlns="http://www.w3.org/2000/svg" class="h-6 cursor-pointer w-6" fill="none" viewBox="0 0 24 24" stroke="#FF0000" stroke-width="1">
