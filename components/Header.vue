<template>
  ...
  <div class="relative bg-white">
    <div class="px-4 sm:px-6 border-b-2 border-gray-100">
      <div class="flex justify-between max-w-7xl mx-auto items-center py-3 md:justify-start md:space-x-10">
        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            -->
            <div class="absolute hidden z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
          ...
          <nuxt-link to="/users" class="text-base font-medium text-gray-900 hover:text-gray-700"> Users </nuxt-link>
          ...
          <div class="relative">
            ...
            <!--
              ...
              Leaving: "transition ease-in duration-150"
                ...
                To: "opacity-0 translate-y-1"
            -->
            <div class="absolute hidden z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
              <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                  <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
        ...
        <div class="md:flex items-center justify-end md:flex-1 lg:w-0" v-if="!$auth.user">
          <nuxt-link to="/sign-in" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Sign in </nuxt-link>
          <nuxt-link to="/register" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Sign up </nuxt-link>
        </div>
        <div class="md:flex items-center justify-end md:flex-1 lg:w-0" v-else>
          <nuxt-link v-if="$auth.user" :to="`/user/${$auth.user.id}`" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-indigo-600 rounded-md shadow-sm text-base font-medium text-indigo-600"> Profile </nuxt-link>
          <button @click="$auth.logout();" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Logout </button>
        </div>
      </div>
    </div>
