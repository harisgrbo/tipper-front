    ...
    <div class="settings-wrapper">
      ...
      <ul class="w-full">
        ...
        <li>
          ...
          <label class="switch">
            <input type="checkbox" v-model="notificationSettings.employee_received_tip" @change="saveNotificationSettings()">
            <span class="slider round"></span>
          </label>
        </li>
        <li>
          ...
          <label class="switch">
            <input type="checkbox" v-model="notificationSettings.add_bank_account" @change="saveNotificationSettings()">
            <span class="slider round"></span>
          </label>
        </li>
        <li>
          ...
          <label class="switch">
            <input type="checkbox" v-model="notificationSettings.remove_bank_account" @change="saveNotificationSettings()">
            <span class="slider round"></span>
          </label>
        </li>
        <li>
          <p>Welcome email</p>
          <label class="switch">
            <input type="checkbox" v-model="notificationSettings.welcome_email" @change="saveNotificationSettings()">
            <span class="slider round"></span>
          </label>
        </li>
        <li>
          ...
          <label class="switch">
            <input type="checkbox" v-model="notificationSettings.user_removed_as_employee" @change="saveNotificationSettings()">
            <span class="slider round"></span>
          </label>
        </li>
      </ul>
